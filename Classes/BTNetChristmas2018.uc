...
class BTNetChristmas2018 expands Mutator;
...
function ModifyPlayer(Pawn Other) {
	...
	if (PlayerPawn(Other) != none) {
		...
		ChristmasTalkTexture = Texture(DynamicLoadObject("BTNetChristmas2018." $ TalkTextureName, class'texture'));
